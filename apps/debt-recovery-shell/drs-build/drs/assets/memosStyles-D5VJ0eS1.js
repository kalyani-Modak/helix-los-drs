import { cH as createSvgIcon, dB as jsxRuntimeExports } from "./index-BhdgJqva.js";
const AccountCircleOutlinedIcon = createSvgIcon([/* @__PURE__ */ jsxRuntimeExports.jsx("path", {
...
const memosFontFamily = '"Inter", "Segoe UI", Arial, sans-serif';
const memosCompactFontSize = "11px";
const memosGridFontSize = 11;
const memosTextSx = {
  fontFamily: memosFontFamily,
  fontSize: memosCompactFontSize
};
export {
  AccountCircleOutlinedIcon as A,
  memosGridFontSize as a,
  memosTextSx as b,
  memosFontFamily as m
};
