import { ed as useIntl, $ as $e, el as useSelector, dN as reactExports, ef as useLocation, dL as qg, dD as lE, dB as jsxRuntimeExports, aX as Kr, aF as FinancialSummaryAPI, ac as Dt, N as CircularProgress, dK as ps, i as Alert, cd as TrendingUp, aW as Kg, cy as bu } from "./index-BhdgJqva.js";
...
function mapFinancialSummaryRow(item, index) {
  ...
  const totalAmt = totalFromApi !== null && Number.isFinite(totalFromApi) ? totalFromApi : computedTotal;
...
function SummaryMetricCard({ label, valueText, valueColor, endAdornment, borderColor }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Kg,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Dt, { sx: { display: "flex", alignItems: "center", gap: 0.5, minHeight: 16, background: "transparent" }, children: [
...
const FinancialSummary = () => {
  const intl = useIntl();
  const { theme, surfaces, text, border } = $e();
  ...
  const accountKey = (selectedRow == null ? void 0 : selectedRow.ACNT_SEQNO) ?? (selectedRow == null ? void 0 : selectedRow.acnt_seqno);
  const formatCurrency = reactExports.useCallback(
    (amount) => {
  ...
  const gridRowData = reactExports.useMemo(() => {
  ...
  const compactCell = reactExports.useMemo(
    () => ({
      fontSize: "12px",
      lineHeight: "38px",
    ...
    return [
      {
        ...
        cellRenderer: (params) => {
          var _a, _b;
          if ((_a = params.data) == null ? void 0 : _a._footer) return null;
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: primary }, children: (_b = params.data) == null ? void 0 : _b.srNo });
        }
      },
      {
        ...
        cellRenderer: (params) => {
          var _a, _b;
          if ((_a = params.data) == null ? void 0 : _a._footer) return null;
          const v = (_b = params.data) == null ? void 0 : _b.feeType;
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: v ? primary : secondary }, children: v || DASH });
        }
      },
      {
        ...
        cellRenderer: (params) => {
          const d = params.data;
          if (d == null ? void 0 : d._footer) {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 600, color: primary }, children: d.feeDescription });
          }
          const v = d == null ? void 0 : d.feeDescription;
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: primary }, children: v || naLabel });
        }
      },
      {
        ...
        filter: false,
        headerStyle,
        cellStyle: { ...compactCell, textAlign: lE.CURRENCY },
        cellRenderer: (params) => {
          const d = params.data;
          const v = num(d == null ? void 0 : d.odAmt);
          if (d == null ? void 0 : d._footer) {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 700, color: error.main }, children: fmt(v) });
          }
          if (v <= 0) {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 500, color: secondary }, children: DASH });
          }
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 500, color: error.main }, children: fmt(v) });
        }
      },
      {
        ...
        cellRenderer: (params) => {
          const d = params.data;
          const v = num(d == null ? void 0 : d.nydAmt);
          if (d == null ? void 0 : d._footer) {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 700, color: warning.main }, children: fmt(v) });
          }
          if (v <= 0) {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: secondary }, children: DASH });
          }
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: warning.main }, children: fmt(v) });
        }
      },
      {
        ...
        cellRenderer: (params) => {
          const d = params.data;
          const v = num(d == null ? void 0 : d.osAmt);
          if (d == null ? void 0 : d._footer) {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 700, color: primary }, children: fmt(v) });
          }
          if (v <= 0) {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 500, color: secondary }, children: DASH });
          }
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 500, color: primary }, children: fmt(v) });
        }
      },
      {
        ...
        cellRenderer: (params) => {
          const d = params.data;
          const v = num(d == null ? void 0 : d.paidAmt);
          if (d == null ? void 0 : d._footer) {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 700, color: success.main }, children: fmt(v) });
          }
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: success.main }, children: fmt(v) });
        }
      },
      {
        ...
        cellRenderer: (params) => {
          const d = params.data;
          const v = num(d == null ? void 0 : d.waivedAmt);
          if (d == null ? void 0 : d._footer) {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 700, color: primary }, children: fmt(v) });
          }
          if (v <= 0) {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: primary }, children: DASH });
          }
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: primary }, children: fmt(v) });
        }
      },
      {
        ...
        cellRenderer: (params) => {
          const d = params.data;
          const v = num(d == null ? void 0 : d.totalAmt);
          if (d == null ? void 0 : d._footer) {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 700, color: primary }, children: fmt(v) });
          }
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 600, color: primary }, children: fmt(v) });
        }
      }
    ];
  ...
  reactExports.useEffect(() => {
    ...
    setIsEmpty(false);
    Kr.GET(FinancialSummaryAPI.FinancialSummary(screenMenuId)).then((res) => {
      if (cancelled) return;
      if (res.status === 204) {
        setRows([]);
        setIsEmpty(true);
      ...
      if (!statusOk && (data == null ? void 0 : data.message)) {
        setRows([]);
        setIsEmpty(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FunctionLayout, { title, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Dt,
    {
      sx: {
        display: "flex",
          ...
          children: [
            loading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Dt,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircularProgress, { size: 32, "aria-label": intl.formatMessage({ id: "label.financialSummary.loading" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ps,
                    {
            ...
            !loading && errorMessage && !rows.length && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { severity: "error", sx: { borderRadius: 2 }, children: errorMessage }),
            !loading && !errorMessage && isEmpty && /* @__PURE__ */ jsxRuntimeExports.jsx(
              ps,
              {
            ...
            !loading && rows.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      SummaryMetricCard,
                      {
                        ...
                        borderColor: border.divider,
                        endAdornment: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { sx: { fontSize: 12, color: text.secondary }, "aria-hidden": true })
                      }
                    )
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Kg, { variant: "outlined", sx: { borderRadius: "8px", borderColor: border.divider, overflow: "hidden" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Dt, { sx: { px: 2, pt: 1.5, pb: 1, background: surfaces.paper }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ps,
                  {
